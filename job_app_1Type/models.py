...
class Constants(BaseConstants):
    ...
    treatment = 3 # Wages of (Job X, Job Y, Job Z) = ...(High, Medium, Low) in treatment 1; (High, Low, Low) in treatment 2; (Medium, Medium, Medium) in treatment 3.
    wages = []
    wage_H = c(4)
    wage_M = c(3)
    wage_L = c(2)
...
# Choose a name treatment:
    name_treatment = 'numbers' # Name treatments: 'numbers', 'females' , 'males' , 'mixed' , 'colors'

    name_in_url = 'job_application_game_1t'
    players_per_group = 3
