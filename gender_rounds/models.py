...
#        cumulative_payoff = sum([p.payoff for p in self.player.in_all_rounds()])
    ...
    def get_offer(self):
        ...
        if self.round_number == 1:
            decider.participant.vars['taken1'] = self.taken
            decider.participant.vars['offer1'] = self.offer
        if self.round_number == 2:
            decider.participant.vars['taken2'] = self.taken
            decider.participant.vars['offer2'] = self.offer
        if self.round_number == 3:
            decider.participant.vars['taken3'] = self.taken
            decider.participant.vars['offer3'] = self.offer
        if self.round_number == 4:
            decider.participant.vars['taken4'] = self.taken
            decider.participant.vars['offer4'] = self.offer
        if self.round_number == 5:
            decider.participant.vars['taken5'] = self.taken
            decider.participant.vars['offer5'] = self.offer
        for p in self.get_players():
            self.offer = Constants.endowment - self.taken
            if self.round_number == 1:
...
#        self.offer1 = self.group.offer5
    ...
    def get_practice_prizes(self):
        self.payoff = (self.q1_is_correct + self.q2_is_correct + self.q3_is_correct + self.q4_is_correct + self.q5_is_correct + self.q6_is_correct + self.q7_is_correct + self.q8_is_correct)*Constants.prize
...
#       for p in self.group.get_players():
        if self.round_number == 1:
            decider.participant.vars['gender_CP_1'] = receiver.participant.vars['gender']
            receiver.participant.vars['gender_CP_1'] = decider.participant.vars['gender']
...
#                p.participant.vars['gender_CP_5'] = self.other_player().gender
        if self.round_number == 2:
            decider.participant.vars['gender_CP_2'] = receiver.participant.vars['gender']
            receiver.participant.vars['gender_CP_2'] = decider.participant.vars['gender']
        if self.round_number == 3:
            decider.participant.vars['gender_CP_3'] = receiver.participant.vars['gender']
            receiver.participant.vars['gender_CP_3'] = decider.participant.vars['gender']
        if self.round_number == 4:
            decider.participant.vars['gender_CP_4'] = receiver.participant.vars['gender']
            receiver.participant.vars['gender_CP_4'] = decider.participant.vars['gender']
        if self.round_number == 5:
            decider.participant.vars['gender_CP_5'] = receiver.participant.vars['gender']
            receiver.participant.vars['gender_CP_5'] = decider.participant.vars['gender']
